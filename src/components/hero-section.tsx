    ...
    >
      ...
      >
        ...
        <div className="order-1 md:order-2">
          <div
            className="relative aspect-[3/4] w-full max-w-md mx-auto md:max-w-none bg-paper shadow-[0_1px_0_0_rgba(26,26,24,0.06),0_24px_48px_-12px_rgba(26,26,24,0.12)] md:mx-0"
            role="img"
